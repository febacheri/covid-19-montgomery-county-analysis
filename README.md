...
This project explores COVID-19 case and death trends in Montgomery County, Pennsylvania, using CDC open data. It demonstrates data cleaning, aggregation, and visualization in R, providing an example of applied statistics and epidemiological analysis.
